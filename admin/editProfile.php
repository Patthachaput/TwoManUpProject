              ...
              <div class="course-content">
                ...
                <form action="editProfile_db.php" role="form" method="post">
                  <div class="form-group row g-3 mb-3">
                    ...
                    <div class="col-12">
                      <div class="form-floating">
                        <input class="form-control" type="tel" id="phone" name="tel" placeholder="xxx-xxx-xxxx" pattern="[0-9]{10}" value="<?php echo $user_profile['tel_number'];?>">
                    ...
                    <div class="col-12">
                      <div class="form-floating">
                        <input class="form-control" type="text" id="school" name="school" placeholder="School" value="<?php echo $user_profile['birthday']; ?>">
                        <label for="school">School</label>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-floating">
                        <input class="form-control" type="text" id="degree" name="degree" placeholder="Degree" value="<?php echo $user_profile['degree']; ?>">
                        <label for="degree">Degree</label>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-floating">
                        <input class="form-control" type="text" id="grade" name="grade" placeholder="Grade" value="<?php echo $user_profile['grade']; ?>">
