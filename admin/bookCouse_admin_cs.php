        ...
        <div class="breadcrumbs">
          ...
          <section id="addCouse" class="addCouse">
            <div class="container justify-content-center align-items-center" data-aos="zoom-in" data-aos-delay="100">
              <!---------------form----------------->
              <h2>Book Couse For Student [student id]:</h2>
              <div class="card mb-3">
                <form action="" id="myForm" role="form" method="post">
                  <div class="card-header bg-transparent">
                    <div class="form-group row">
                      ...
                      <input class="col-2 btn btn-success" type="button" id="submitFormData" onclick="SubmitFormData1();" value="Submit">
                    </div>
                  </div>
                </form>
                <form action="" role="form" method="post">
                  <div class="card-body" id="results">
                    <table class="table">
                       ...
                       <td>Couse ID:</td>
                       <td>1234</td>
                        <td><h5>Couse Name:</h5></td>
                        <td>Physic for good people</td>
                        <td><h5>Detail:</h5></td>
                        <td><p>dfiusghfiulshfglihlhliuvhfsviefhv
                        liugilgb,b,gb,hjglyv,hjgylyho;iehfeor;ghilerughleiuhgileh
                      gei;rhfge;oighe;ogheo;ihfge;
                    ogheorfghgvilgvfugvelivgfilvg</p></td>
                        <td>
                          <div class="form-check">
                            <center><input type="checkbox" class="btn-check" id="btn-check-2-outlined" name="book2" value="2"checked autocomplete="off">
                            <label class="btn btn-outline-secondary" for="btn-check-2-outlined">booked</label></center>
                          </div>
                        </td>
                      </tr>
                      <tr>
